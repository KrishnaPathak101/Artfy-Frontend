...
const SellArt = () => {
    ...
    useEffect(() => {
        if (artId) {
            const getArtInfo = async () => {
                try {
                    const response = await fetch(`https://artify-backend-gk1b.onrender.com/api/art/${artId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        const url = artId ? `https://artify-backend-gk1b.onrender.com/api/sell-art/${artId}` : 'https://artify-backend-gk1b.onrender.com/api/sell-art';
        try {
